...
<table align="center" border="0" cellspacing="0" cellpadding="5" >
  <tr> 
	...
	<input type="text" name="memid" 
				value="<c:out value="${regBean.memid}"/>"></td>
          </tr>
          <tr> 
            <td>패스워드</td>
            <td><input type="text" name="pwd" 
	value="<c:out value="${regBean.pwd}"/>"></td>
          </tr>
          <tr> 
            <td>이름</td>
            <td><input type="text" name="memname" 
			value="<c:out value="${regBean.memname}"/>"></td>
          </tr>
          <tr> 
            <td>이메일</td>
           <td><input type="text" name="email"  size="30" 
		   value="<c:out value="${regBean.email}"/>"></td>
          </tr>
          <tr> 
            <td>전화번호</td>
            <td><input type="text" name="mphone" 
			 value="<c:out value="${regBean.mphone}"/>"></td>
          </tr>
		  <tr> 
            <td>우편번호</td>
            <td><input type="text" name="zipcode" 
			value="<c:out value="${regBean.zipcode}"/>"></td>
          </tr>
		  <tr> 
            <td>주소</td>
           <td><input type="text" name="addr" size="50" 
		    value="<c:out value="${regBean.addr}"/>"></td>
          </tr>
          <tr> 
